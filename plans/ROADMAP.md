...
| M3 ✅ | NemPay — escrow mode — **done** (8 ACs + segregation invariant; escrow suite + regression + live e2e) | [spec](../specs/003-nempay-escrow/spec.md) | [plan](./003-nempay-escrow/plan.md) |
